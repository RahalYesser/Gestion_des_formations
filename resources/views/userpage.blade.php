        ...
        <div class="modal-content">
            ...
            <div class="container">
                            <div class="container">
                                ...
                                <h2 class="page-section-heading text-center text-uppercase text-secondary mb-0">REGISTER FOR TRAINING</h2>
                                <!-- Icon Divider-->
                                ...
                                <div class="row justify-content-center">
                                    <div class="col-lg-8 col-xl-7">
                                        <form id="contactForm" data-sb-form-api-token="API_TOKEN" action="" method="POST" enctype="multipart/form-data">
                                            ...
                                            <button class="btn btn-primary btn-xl" type="submit">Register</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
